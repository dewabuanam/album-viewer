...
interface FullImage4GridPageProps {
  content: PageContent
}

export function FullImage4GridPage({ content }: FullImage4GridPageProps) {
  ...
  return (
    <>
      ...
      >
        <motion.div variants={containerVariants} className="grid grid-cols-2 gap-0 w-full h-full">
