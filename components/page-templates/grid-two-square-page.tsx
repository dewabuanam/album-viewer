...
interface GridTwoSquarePageProps {
  content: PageContent
}
...
export function GridTwoSquarePage({ content }: GridTwoSquarePageProps) {
  ...
  return (
    <>
      <div className="w-full h-full p-4 sm:p-8 md:p-12 flex flex-col justify-center">
        ...
        {/* Two Square Images */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-6 flex-1">
          {images.slice(0, 2).map((image, index) => (
            <motion.div
              ...
              className="relative rounded-2xl overflow-hidden shadow-lg cursor-pointer group h-40 sm:h-48 md:h-64"
